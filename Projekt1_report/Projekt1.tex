...
$<=> s'_{2}s_{1}s_{0}+s_{2}s'_{1}s'_{0}+s'_{2}s_{1}s'_{0}+s_{2}s_{1}s'_{0}$
...
$<=> s'_{2}s'_{1}s_{0}+s'_{2}s_{1}s'_{0}+s_{2}s'_{1}s_{0}+s_{2}s_{1}s'_{0}$
