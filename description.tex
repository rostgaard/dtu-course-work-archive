...
In order to measure the X coordinate of the touched place on the LCD screen a potential gradient has to be applied to the bars represented as X_{1} and X_{2} on Figure \ref{fig:LCD_screen_measurement}. The actual X coordinate
