...
Since the offset is approximately zero we can wrtie that maximum an minimum values of volatege are $ \pm333.75V $. The maximum and minimum number of bits after ADC conversions were 1002 and 20. Hence the zero Volts was represented by $ (1002_{bits}-20_{bits})/2=491_{bits} $ and $ 1_{bit}=333.75_{volts}/491_{bits}=0.679735234_{volts} $.
