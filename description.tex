...
\begin{figure}[!h]
  \centering
  \subfloat[Cut-off at 100Hz]{\label{fig:100@10}\includegraphics[width=0.3\textwidth]{img/used/100Hz@10kHz_small.png}}       \subfloat[Cut-off at 50Hz]{\label{fig:50@10}\includegraphics[width=0.3\textwidth]{img/used/50Hz@10kHz_small.png}}
...
\begin{figure}[!h]
  \centering
  \subfloat[Main screen]{\label{fig:main_scr}\includegraphics[width=0.3\textwidth]{img/main_menu_small.jpg}}       \subfloat[Config screen]{\label{fig:config_scr}\includegraphics[width=0.3\textwidth]{img/config_small.jpg}}
  \subfloat[Test screen]{\label{fig:test_scr}\includegraphics[width=0.3\textwidth]{img/test_screen_screen.jpg}}
