...
public class MandatoryTests {
    ...
    public void testP1() {
        ...
        for (int i = 0; i < flightBookingList.size(); i++) {
            ...
            TestHelpers.compareFlightInformation(flightBooking.getFlightInformation(), flightInfo[i]);
        }
        ...
        for (int i = 0; i < hotelBookingList.size(); i++) {
            ...
            // Check information
            TestHelpers.compareHotelInformation(hotelBooking.getHotelInformation(), hotelInfo[i]);
        }
