...
public class StatusPanel{
	...
	private final int height = 100; //height of the panel in pixels
		...
		textArea.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if(arg0.getButton() == MouseEvent.BUTTON3 && arg0.getClickCount() == 1) {
					...
					//clear panel menu - clear the text on the panel
...
//					//clear graph menu - resets the colors on the network graph
