...
% Usage: \setdate{<hand-in date>}
	\setdate{October 9th, 2013}

%% Add the authors of the report
% Usage: \addauthor{<study number>}{<first name(s)>}{<last name>}
	\addauthor{s093477@student.dtu.dk}{Ibrahim}{Nemli}
	\addauthor{s084283@student.dtu.dk}{Kim Rostgaard}{Christensen}
	\addauthor{s093263@student.dtu.dk}{Peter Gammelgaard}{Poulsen}
