...
\end{table}
\\\\
Furthermore a graphical representation can be created of a flow graph to give a better overview. Figure~\ref{fig:flowgraph} shows the Flow Graph for our example program.
\begin{figure}[h]
\centering
\begin{tikzpicture}
